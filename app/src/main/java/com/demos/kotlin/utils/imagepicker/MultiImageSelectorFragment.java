package com.demos.kotlin.utils.imagepicker;
...
import com.demos.kotlin.utils.imagepicker.adapter.FolderAdapter;
import com.demos.kotlin.utils.imagepicker.adapter.ImageGridAdapter;
import com.demos.kotlin.utils.imagepicker.bean.Folder;
import com.demos.kotlin.utils.imagepicker.bean.Image;
import com.demos.kotlin.utils.imagepicker.utils.FileUtils;
import com.demos.kotlin.utils.imagepicker.utils.ScreenUtils;
    ...
    private void takePhoto() {
        ...
        if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            try {
                ...
                photoUri = FileProvider7.getUriForFile(
                        getContext(),
                        mTmpFile);
            } catch (IOException e) {
                e.printStackTrace();
            ...
            if (mTmpFile != null && photoUri != null && mTmpFile.exists()) {
            ...
            if (mode == MODE_MULTI) {
                if (resultList.contains(image.path)) {
                    ...
                    if (selectImageCount() == resultList.size()) {
                        ...
                        Toast.makeText(getActivity(), "你最多可以选择" + resultList.size() + "张照片", Toast.LENGTH_SHORT).show();
                        return;
                    }

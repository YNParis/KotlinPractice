...
public class CustomCandleRender extends CandleStickChartRenderer {
    ...
    private float barLeftSpace;
    private float barRightSpace;
    ...
    public CustomCandleRender(CandleDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
...
*/
                ...
                //TODO 修改绘制小方块的位置
                mBodyBuffers[0] = xPos - 0.25f + barLeftSpace;
                mBodyBuffers[1] = close * phaseY;
                mBodyBuffers[2] = xPos + barLeftSpace;
                mBodyBuffers[3] = open * phaseY;

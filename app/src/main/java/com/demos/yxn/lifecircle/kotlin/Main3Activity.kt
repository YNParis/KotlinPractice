...
class Main3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val person = Person("Ada", 29)
//        var person2 = person.copy("Lisa")
        println("person's name is ${person.name} and age is ${person.age}")
//        println("person2's name is ${person2.name} and age is ${person2.age}")
